...
public class UpdateQuestionBankDtoValidator : AbstractValidator<UpdateQuestionBankDto>
{
    public UpdateQuestionBankDtoValidator()
    {
    ...
    private bool HaveOptionsForChoiceQuestions(UpdateQuestionBankDto dto, List<CreateQuestionBankOptionDto> options)
    {
